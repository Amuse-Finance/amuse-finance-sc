...
contract AmuseToken is Ownable, IERC20 {
    ...
    constructor() {
        ...
        IUniswapV3Factory uniswapNonfungiblePositionManager = INonfungiblePositionManager(0xC36442b4a4522E871399CD717aBDD847Ab11FE88);
        // WETH = 0xc778417E063141139Fce010982780140Aa0cD5Ab;
        WETH = uniswapNonfungiblePositionManager.WETH9();

        excluded[address(this)] = true;
        excluded[address(uniswapV3Factory)] = true;
        // excluded[address(uniswapNonfungiblePositionManager)] = true; // Uniswap NonfungiblePositionManager address
        excluded[0xE592427A0AEce92De3Edee1F18E0157C05861564] = true; // SwapRouter address
