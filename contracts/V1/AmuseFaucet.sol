...
contract AmusedFaucet is Ownable {
    ...
    function isValidWithdrawal(address _account) public view returns(bool) {
        require(block.timestamp > lastWithdrawTime[_account] + faucetInterval, "AmusedFaucet: Faucet has already been issued to address");
        return true;
    }
